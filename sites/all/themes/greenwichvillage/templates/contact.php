...
if(mail($address, $e_subject, $msg, $headers)) { echo "<fieldset><div id='success_page'><h4>Email Sent Successfully.</h4><p>Thank you $name, your message has been submitted to us.</p></div></fieldset>"; } else print $address.'ok';